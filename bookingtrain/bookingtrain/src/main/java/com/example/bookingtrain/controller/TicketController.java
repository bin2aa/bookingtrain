...
public class TicketController {
    ...
    @Autowired
    public TicketController(TicketService ticketService, PassengerService passengerService, StationService stationService) {
    ...
    public String saveTicket(@ModelAttribute("ticket") Ticket ticket) {
        ...
        Station stationDepartured = stationService.getById(ticket.getStationDepartureId());
        Station stationArrival = stationService.getById(ticket.getStationArrivalId());
