...
public class InfoReservationRepository {
    ...
    public List<InforReservationDTO> findAvailableSeatsByStations(Long stationDepartureId, Long stationArrivalId, String dateStart) {
        String sql = "SELECT " +
                ...
                "JOIN stations sd ON sd.stationId = ro.stationDepartureId " +  // Kết nối với bảng stations (Ga khởi hành)
        ...
        return jdbcTemplate.query(sql, new Object[] { stationDepartureId, stationArrivalId, dateStart },
                (rs, rowNum) -> {
